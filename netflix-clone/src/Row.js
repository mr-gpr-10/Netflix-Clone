...
// fetchurl is to get the movies list
// isLargeRow to used for displaying horzontal posters instead of vertical posters
...
{/* u idiot use parenthesis() and not braces because you have spent an entire day finding out this error */}
                {movies.map((movie)=>(
                    // key is used to increase scrolling speed
